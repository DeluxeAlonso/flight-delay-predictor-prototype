...
APP.FlightScreen.prototype.evalBtnHandler = function () {
  ...
  $.ajax({
      ...
      if (response.data.score > 0.5) {
        ...
        //scope.titleBottom.css("color", "#FF0000");
      } else {
        scope.titleBottom.text("El vuelo no se retrasará.");
        //scope.titleBottom.css("color", "#a4a3bf");
      }
...
APP.FlightScreen.prototype.validateFields = function () {
  ...
  if (this.humidity.val() < 0 || this.humidity > 100) errors.push("El porcentaje de humedad tiene que estar entre 0 y 100.");
  return errors;
};
